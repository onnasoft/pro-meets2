    ...
    <div className="flex items-center">
      <div className="relative" ref={menuRef}>
        <button
          ...
          className="flex items-center justify-between px-4 py-3 text-sm font-medium rounded-lg hover:bg-gray-100 w-[380px] border border-gray-200"
        >
        ...
        {isOpen && (
          <div className="absolute left-0 mt-2 w-[380px] origin-top-left bg-white rounded-lg shadow-xl ring-1 ring-black ring-opacity-5 focus:outline-none z-50 divide-y divide-gray-100 border border-gray-200">
